...
public class NodeTaggerTikaContent implements Serializable {


	public NodeTaggerTikaContent(Long tagFileId) {
		super();
		this.tagFileId = tagFileId;
		this.mapAttribute = new HashMap<String, String>();
	}

	public NodeTaggerTikaContent(Long tagFileId, String fileType) {
		super();
		this.tagFileId = tagFileId;
