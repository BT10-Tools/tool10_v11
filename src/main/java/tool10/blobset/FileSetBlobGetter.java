...
import tool10.fileset.FilePropertySetter;
...
public class FileSetBlobGetter {
	...
	private static byte[] getFileBlobBytes(NodeFileSet fileSet, NodeFile nodeFile, NodeFileBlobOld fileBlob) {
	...
	public static int getCntPartForFileBig(NodeFileSet fileSet, NodeFile nodeFile, int partNumber) {
		for (NodeFileBlobOld blobPart: nodeFile.getListFileBlobBig())	{
