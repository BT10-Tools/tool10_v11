...
public class NodeBlobHash  implements Serializable {
	...
	public NodeBlobHash(Long blobHashId, Long blobId, Long blobEntityId, Long blobSetId, Long blobSize,ZonedDateTime creationDate) {
		super();
		this.blobHashId = blobHashId;
		this.blobId = blobId;
		this.blobEntityId = blobEntityId;
	...
	public void setBlobHashId(Long blobHashId) {
		this.blobHashId = blobHashId;
	}
