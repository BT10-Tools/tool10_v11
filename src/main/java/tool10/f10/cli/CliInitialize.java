...
public class CliInitialize {
	...
	private static int getOptionsMedia(Options options) {
	    ...
	    options.addOption("mediatype", true, "media type image, video, audio");
	    options.addOption("dbname", true, "The name of the database/filename");
	    options.addOption("filesetname", true, "The name of the file set");
		...
		options.addOption("mediadbtype", true, "The type of the media database");
	...
	private static int getOptionsDoc(Options options) {
		int cntOptions = options.getOptions().size();
	    options.addOption("doc", false, "create documents of files in a fileset");
	    options.addOption("dbname", true, "The name of the database/filename");
	    options.addOption("filesetname", true, "The name of the file set");
	    options.addOption("docsetname", true, "The name of the document file set");
		options.addOption("tempdir", true, "The temporary directory name for documents, default is default temporary directory");
		options.addOption("docdbname", true, "The name of the document database");
		options.addOption("docdbaction", true, "The action for the document database, newdb, renewdb, newfileset, appendfile, usedb, default is newdb");
