...
public class CliParameter implements Serializable {
	...
	private String mediaDbType; 
	private String mediaDbName;
	private String mediaDbAction; //newdb, newroot, 
	
	private String doc;
	private String docSetName;
	private String docDbType; //not required, default, sqlite. ser serialization will come. in future pg, oracle, mysql,...
	private String docDbName;
	private String docDbAction; //newdb, newroot, 
	...
	public String getDocDbType() {
		return docDbType;
	}
	public void setDocDbType(String docDbType) {
		this.docDbType = docDbType;
	}
	...
	public String getDocDbAction() {
		return docDbAction;
	}
	public void setDocDbAction(String docDbAction) {
		this.docDbAction = docDbAction;
	}
