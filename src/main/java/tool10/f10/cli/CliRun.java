...
public class CliRun {
	...
	public static String[] getArgs0(String argsType)	{
		...
		String[] argsLoad1 = new String[] {"",
				...
				"-dir","C:\\tmp\\similarity\\10_Media\\01_video"
				};
		...
		String[] args10 = new String[] {"",
				...
				"-dbname","C:\\app\\sqlite\\similarity\\fileSet02.db",
				"-filesetname","fileSet02",
				"-docsetname","fileSet02_Doc",
				"-docdbname","C:\\app\\sqlite\\similarity\\fileSet02Doc.db",  //this is optional, default and preferred is current db  
				"-docdbaction","renewdb",
				"-tempdir","C:\\tmp\\similarity\\11_Doc"
				};
		...
		else if ("media".equalsIgnoreCase(argsType)) 	{	return(argsMedia);	}
