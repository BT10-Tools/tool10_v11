...
public class CreateFileSetTables {
	...
	public static int createTable(Connection conn,String tableName)	{
		//"REG_ENTITYID","FS_FILESET","FS_FS","FS_FILE","FS_FILEBLOB","FS_FILEGROUP","FS_FILEGROUPMEMBER",
		//"FS_HASH","FS_HOST","FS_QUERY","FS_STAT"
		int cntUpdated = -1;
		//{tblList = new String[] {"TXT_CORPUS","TXT_FILE","TXT_FILEGROUP","TXT_FILETYPE","TXT_LINE","TXT_LINEGROUP","TXT_LINETEMPLATE",
		//"TXT_PHRASE","TXT_REF","TXT_STAT","TXT_TOKEN","TXT_TOKENTYPE","TXT_DISTANCE"}; }
	...
	*/		
		...
		} else if ("TXT_STAT".equals(tableName))	{
	...
	public static int createFileSetTables(Conn10 conn10)	{
		...
		for (String tblName : tblList)	{
			if (1==createTable (conn10.getConn(),tblName)) 	{System.out.println(tblName+" table created");}
		}		
