...
public class NodeFileOld implements Serializable {

	public NodeFileOld(Long fileId, Long fileSetId, Long fileSystemId, Long fileStoreId, Long parentFileId, Long rootFileId, Long fileTypeId,
	...
	public NodeFileOld(Long fileId, Long fileSetId, Long parentFileId, Long fileSize, String fileStatus, String fileName, 
	...
	private void initializeListsAndMaps()	{ 
		this.listSiblingFile = new ArrayList<NodeFileOld>();
	...
	private ArrayList<NodeFileOld> listSiblingFile;
	...
	class SortByFileName implements Comparator<NodeFileOld> {
		@Override
		public int compare(NodeFileOld a, NodeFileOld b) {
	...
	public void sortListSiblingFile()	{
		...
		Comparator<NodeFileOld> myComparator = new SortByFileName();		
	...
	public ArrayList<NodeFileOld> getListSiblingFile() {
